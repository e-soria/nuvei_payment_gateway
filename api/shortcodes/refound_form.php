                ...
                if ( !empty($_POST['transaction_id']) ) {
                    ...
                    if ( $refound['status'] === 'success' ) { ?>
                        ...
                        <div class='alert error-alert'>
                            ...
                            Revisa que el ID de la transacción sea el correcto o contáctate con <a hreF="mailto:soporte@staging.hiitclub.online">soporte@staging.hiitclub.online</a> para recibir ayuda.</p>
                        </div>
                        ...
                        <div class='alert info-alert'>
                            ...
                            Contáctate con <a hreF="mailto:soporte@staging.hiitclub.online">soporte@staging.hiitclub.online para recibir ayuda.</a></p>
                        </div>
